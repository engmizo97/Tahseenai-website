...
export default function Footer({ lang = "en" }: FooterProps) {
  ...
  const content = {
    ar: {
      ...
      solutionsList: [
        { name: "تحسين التعليمية (الرئيسية)", href: "https://edutahseen.com" },
        { name: "منصة قدرات", href: "https://edutahseen.com/qudurat" },
        { name: "منصة تحصيلي", href: "https://edutahseen.com/tahsili" },
        { name: "منصة بوصلتي", href: "https://edutahseen.com/busalati" },
    ...
    en: {
      ...
      solutionsList: [
        ...
        { name: "Qudurat Platform", href: "https://edutahseen.com/qudurat" },
        { name: "Tahsili Platform", href: "https://edutahseen.com/tahsili" },
        { name: "Bawsalati Assessment", href: "https://edutahseen.com/busalati" },
        { name: "AI Agents & Consulting", href: `${homePrefix}/#services` },
        { name: "Workflow Automation", href: `${homePrefix}/#services` },
      ],
      colCompany: "Company",
      companyList: [
